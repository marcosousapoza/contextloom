...
curl --fail --location --output ~/contextloom/contextloom.yml \
  https://raw.githubusercontent.com/marcosousapoza/contextloom/v0.2.0/deploy/contextloom.yml
```
...
matching tag, such as `v0.2.0`. The container workflow rejects malformed tags and tags that
