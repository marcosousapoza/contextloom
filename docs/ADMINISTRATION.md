...
curl --fail --location --output ~/contextloom/contextloom.yml \
  https://raw.githubusercontent.com/marcosousapoza/contextloom/v1.0.2/deploy/contextloom.yml
```
...
matching tag, such as `v1.0.2`. The container workflow rejects malformed tags and tags that
