...
```console
podman kube play --replace https://raw.githubusercontent.com/marcosousapoza/contextloom/v0.2.0/deploy/contextloom.yml
```
...
The release manifest pulls `ghcr.io/marcosousapoza/contextloom:0.2.0`. The same release image
...
podman build -t localhost/contextloom:0.2.0 .
```
