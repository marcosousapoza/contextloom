...
```console
podman kube play --replace https://raw.githubusercontent.com/marcosousapoza/contextloom/v1.0.2/deploy/contextloom.yml
```
...
The release manifest pulls `ghcr.io/marcosousapoza/contextloom:1.0.2`. The same release image
...
podman build -t localhost/contextloom:1.0.2 .
```
